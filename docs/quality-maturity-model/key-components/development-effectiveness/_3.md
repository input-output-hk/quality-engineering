...
-   Software development practices are well-defined and documented, aligned at the Tribe level, in a consistent format (the [TODO:Quality Strategy](#)), and are consistently followed by all squads.
...
-   A [TODO:shift-left](#) approach is regularly employed, leading to early defect identification and remediation.
...
-   All **tests** at all levels **are peer-reviewed** by the team, including test engineers, and adhere to IOG’s test automation **best** [TODO:practices and conventions](#).
