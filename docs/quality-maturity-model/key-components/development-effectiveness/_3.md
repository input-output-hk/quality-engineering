...
-   Software development practices are well-defined and documented, aligned at the Tribe level, in a consistent format (the [Quality Strategy](/quality-strategy)), and are consistently followed by all squads.
...
-   All **tests** at all levels **are peer-reviewed** by the team, including test engineers, and adhere to IOG’s test automation **best** [practices and conventions](https://input-output.atlassian.net/wiki/spaces/CI/pages/3832512556/IOG+Test+Automation+Best+Practices).
